package pers.crescent.bpNeureNetwork.application;
import pers.crescent.bpNeureNetwork.bpnn.BPData;
import pers.crescent.bpNeureNetwork.bpnn.BPNN;

import java.io.*;
import java.util.ArrayList;
import java.util.List;

public class BPNNApplication {
    ...
    public static void main(String args[]) {
        ...
        // 读取iris数据
        try {
            String pathname = "//Users//crescent//Documents//project//artificial_intelligence//bp_neure_network//src//pers//crescent//bpNeureNetwork//application//wine.txt"; // 绝对路径或相对路径都可以，这里是绝对路径，写入文件时演示相对路径
        ...
        trainData = new BPData[datas.size()*2/3];
        testData = new BPData[datas.size()-trainData.length];
        ...
        BPNN bpnn = new BPNN(trainData, testData, 0.5, attNum-1, 5, 3);
        bpnn.predict_2();
    }
